package jpabook.jpastudy2.repository.order.query;
...
public class OrderQueryRepository {
    ...
    private List<OrderQueryDto> findOrders() {
        return em.createQuery(
                "select new jpabook.jpastudy2.repository.order.query.OrderQueryDto(o.id, m.name, o.orderDate, o.status, d.address)" +
                        " from Order o" +
                        " join o.member m" +
